        ...
        for epoch in range(args.epochs):
            with tqdm(range(len(train_dataset))) as pbar:
                for i, imgs in zip(pbar, train_dataset):
                    full_dose_img = imgs[0]
                    imgs = imgs[1]
                    imgs = imgs.to(device=args.device)
                    full_dose_img = full_dose_img.to(device=args.device)
                    import ipdb 
                    ipdb.set_trace()
                    ...
                    perceptual_loss = self.perceptual_loss(full_dose_img, decoded_images)
                    rec_loss = torch.abs(full_dose_img - decoded_images)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fulldose-dataset-path', type=str, default='CT_data_imgs/train/full_1mm', help='Path to data (default: /CT_Data_imgs)')
    parser.add_argument('--lowdose-dataset-path', type=str, default='CT_data_imgs/train/quarter_1mm', help='Path to data (default: /data)')
